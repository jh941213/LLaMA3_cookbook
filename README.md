...
| 메모리        | 128GB                               | 16GB                      | 32GB                                        |
| GPU 메모리    | 없음                                | 없음                      | 24GB                                        |
| **Llama 2 모델 7B** | - 모든 컴퓨터에서 잘 작동            | - 모든 컴퓨터에서 잘 작동   | - 모든 컴퓨터에서 잘 작동                    |
|               | - 성능 M3 Max와 유사                  |                           | - 성능 M3 Max와 유사                          |
| **Llama 2 모델 13B**| - 성능 좋음                        | - 세 번째로 성능 좋음       | - 가장 성능 좋음                             |
| **Llama 2 모델 70B**| - 빠르게 실행, 128GB 메모리 활용    | - 16GB 부족, 크래시 및 재부팅 | - GPU에서 실행 불가, CPU에서 매우 느리게 실행 |
| 전력 소모      | 65W                                |                           | 250-300W                                    |
